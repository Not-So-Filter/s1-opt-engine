...
PalCycle_Index:	dc.w PalCycle_GHZ-PalCycle_Index
		...
		dc.w PCycGHZ_Skip-PalCycle_Index
...
PCycGHZ_Go:
		...
		move.b	#5,(v_pcyc_time).w ; reset timer to 5 frames
...
; Waterfalls
		...
		move.b	#2,(v_pcyc_time).w ; reset timer to 2 frames
...
loc_1B06:
		...
		move.b	#1,(v_pcyc_time).w
		tst.b	(v_act).w
		beq.s	loc_1B2E
		lea	Pal_SBZCyc10(pc),a0
		move.b	#0,(v_pcyc_time).w
