...
DLE_LZ3:
		...
		cmpi.w	#$1718,(Level_layout_header+$1F2).w	; MJ: is current layout already set to wall version?
		beq.s	loc_6F28				; MJ: if so, branch to skip
		move.w	#$1718,d3
		lea	(Level_layout_header+$1F2).w,a1
		moveq	#2-1,d2

.loop:
		move.w	d3,(a1)+
		dbf	d2,.loop
;		move.w	#$1718,(Level_layout_header+$1F2).w	; MJ: Set wall version of act 3's layout to be read
