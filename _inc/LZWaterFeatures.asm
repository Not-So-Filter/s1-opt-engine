...
LZWaterFeatures:
		tst.b	(f_water).w ; check if level is LZ
...
.setheight:
		...
		st.b	(f_wtr_state).w ; screen is all underwater
...
DynWater_LZ2:
		...
		move.w	#$328,d1
		cmpi.w	#$500,d0
		bcs.s	DynWater_LZ1.setwater2
		move.w	#$3C8,d1
		cmpi.w	#$B00,d0
		bcs.s	DynWater_LZ1.setwater2
		move.w	#$428,d1
		bra.s	DynWater_LZ1.setwater2
; ===========================================================================
...
DynWater_LZ3:
		...
		move.w	#$F8F9,d3
		lea	(Level_layout_header+$1F2).w,a0
		moveq	#2-1,d2
...
.chksonic:
		...
		bsr.w	PlaySound_Special	; play rushing water sound (only every $40 frames)
...
loc_3F9A:
		...
		st.b	(f_slidemode).w	; set water slide flag
		moveq	#$1F,d0
		and.b	(v_vbla_byte).w,d0
		bne.s	locret_3FBE
		moveq	#sfx_Waterfall,d0
		bra.w	PlaySound_Special	; play water sound
