...
Spik_Wait:
		tst.b	objoff_38(a0)		; is time delay	= zero?
		beq.s	loc_CFA4	; if yes, branch
		subq.b	#1,objoff_38(a0)	; subtract 1 from time delay
		bne.s	locret_CFE6
		tst.b	obRender(a0)
		bpl.s	locret_CFE6
		moveq	#sfx_SpikesMove,d0
...
loc_CFA4:
		...
		move.b	#60,objoff_38(a0)	; set time delay to 1 second
		rts
; ===========================================================================
