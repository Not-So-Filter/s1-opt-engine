...
GMake_Main:	; Routine 0
		...
		move.w	#$80*1,obPriority(a0)
		move.b	#$38,obActWid(a0)
		move.b	#120,gmake_time(a0) ; set time delay to 2 seconds

GMake_Wait:	; Routine 2
		subq.b	#1,gmake_timer(a0) ; decrement timer
		bpl.s	.cancel		; if time remains, branch

		move.b	gmake_time(a0),gmake_timer(a0) ; reset timer
